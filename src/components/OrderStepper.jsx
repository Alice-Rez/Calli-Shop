...
export default function OrderStepper() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="-5 0 183 54">
      <g transform="translate(-12.5494 -236.2829)">
        ...
        <text
          ...
          strokeWidth=".2646"
        >
          <tspan x="23.5101" y="250.5845" fontWeight="700" fontFamily="Raleway">
            1
          </tspan>
        </text>
        <circle
        ...
        <text
          ...
          strokeWidth=".2646"
        >
          <tspan x="97.5437" y="250.963" fontWeight="700" fontFamily="Raleway">
            2
          </tspan>
        </text>
        <path
